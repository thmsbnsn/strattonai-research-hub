...
const AITraderDashboard = lazy(() => import("@/pages/AITraderDashboard"));
...
export default function Dashboard() {
  return (
    <AppLayout>
      {(mode) =>
        mode === "trader" ? (
          <Suspense fallback={<div className="text-muted-foreground text-sm animate-pulse">Loading AI Trader…</div>}>
            <AITraderDashboard />
          </Suspense>
        ) : (
          <ResearchDashboard />
